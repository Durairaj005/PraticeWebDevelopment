...
import { UserPlus, Loader2, Sparkles, ShieldCheck, TrendingUp } from 'lucide-react';
...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.post('/users/register', {
        ...
        passout_year: parseInt(passoutYear) || undefined
      });
      ...
      const user = await login(loginResponse.data.access_token);
  ...
  return (
    <div className="min-h-screen flex bg-slate relative overflow-x-hidden">
      {/* LEFT SIDE - BRANDING (Hidden on Mobile) */}
      <div className="hidden lg:flex w-1/2 relative flex-col justify-between p-12 overflow-hidden border-r border-white/5 sticky top-0 h-screen">
        ...
        >
          ...
          <p className="text-lg text-white/70 mb-10 leading-relaxed">
            Create your account to start submitting feedback and tracking your campus experience.
          </p>
          ...
          <div className="space-y-4">
            <div className="glass-panel p-4 flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-white">Verified Students Only</h3>
                <p className="text-sm text-white/50">Ensure a safe and authentic environment.</p>
              </div>
            </div>
            <div className="glass-panel p-4 flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-white">Instant Resolutions</h3>
                <p className="text-sm text-white/50">Direct pipeline to department heads.</p>
              </div>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 lg:p-8 relative min-h-screen py-12">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-8">
            ...
            <p className="text-white/60">Join InsightOS to share your feedback</p>
          </motion.div>
          ...
          <motion.div variants={fadeUp} className="glass-panel p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label className="block text-sm font-medium text-white/80 mb-2 ml-1">Enrollment / Roll Number</label>
                <input
                  type="text"
              ...
              <div className="flex gap-4">
                <div className="flex-1">
                  <label className="block text-sm font-medium text-white/80 mb-2 ml-1">Current Year</label>
                  <select
                    value={currentYear}
                ...
                <div className="flex-1">
                  <label className="block text-sm font-medium text-white/80 mb-2 ml-1">Pass Out Year</label>
                  <input
                    type="number"
                    value={passoutYear}
